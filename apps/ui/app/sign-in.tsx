    ...
    <GestureHandlerRootView className="flex-1">
      <View className="flex-1 bg-primary">
        <SafeAreaView className="flex flex-1 flex-col justify-end px-4 pb-5">
          <Text className="mb-2 font-inter-regular text-5xl text-white">
            Jejak
          </Text>
          ...
          <BottomSheetView className="flex-1 px-6 py-6">
            ...
            <View>
              <View className="mb-6 flex-row items-center gap-4">
                ...
                <Text className="font-inter-regular text-[#ABAFB5]">
                  atau masuk dengan
                </Text>
                <View className="h-[1px] flex-1 bg-[#ABAFB5]" />
              </View>
              ...
              <View className="flex flex-row items-center justify-center gap-3">
                ...
                >
                  ...
                  />
                  <Text className="font-inter-semi-bold text-[#4B4D53]">
                    Google
                  </Text>
                </Pressable>
                ...
                <Pressable className="w-1/2 flex-row items-center justify-center gap-3 rounded-2xl border border-[#ABAFB5] bg-white px-6 py-4">
                  <Image
                    ...
                    style={{ width: 19, height: 19 }}
                  />
                  <Text className="font-inter-semi-bold text-base text-[#4B4D53]">
                    Apple ID
                  </Text>
                </Pressable>
              </View>
