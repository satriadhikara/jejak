...
export default function LaporanNew() {
  ...
  return (
    <View className="flex-1 bg-[#FAFAFB] pt-14">
      ...
      <View className="mx-5 rounded-xl bg-[#FFF7D4] px-3 py-3 flex-row items-start">
        <Ionicons name="alert-circle" size={18} color="#C56A08" style={{ marginTop: 2 }} />
        <View className="ml-3 flex-1">
          <Text className="font-inter-semi-bold text-sm text-[#C56A08]">
            Segera tinjau laporan yang baru masuk
          </Text>
          <Text className="font-inter-regular text-xs text-[#C56A08] mt-1 leading-5">
            Daftar laporan yang baru masuk dan perlu konfirmasi validitas kerusakan
          </Text>
        </View>
      </View>
